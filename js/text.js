...
let memo = document.getElementById("text");

document.getElementById("notes__l").addEventListener("click", function () {
  memo.value = memo.value.toLowerCase();
});

document.getElementById("notes__u").addEventListener("click", function () {
  memo.value = memo.value.toUpperCase();
});

document.getElementById("notes__c").addEventListener("click", function () {
